...
export FUNCTION_NAME="CIRCUITS_ENGINE_UPDATE_CIRCUIT"
export HANDLER=update.handler
export DESCRIPTION='Assigns a Task'
...
MD5=`cat update.js | md5sum | cut -d' ' -f1`
